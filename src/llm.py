...
class LLM:
    ...
    def get_chain():
        system_prompt = """
            ...
            You are an expert on the software consulting company Source Allies.
            Given a question from someone and documents/information pulled from the Source Allies website, create a well thought out answer.
